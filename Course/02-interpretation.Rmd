...
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/coeff.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/pvalue.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/R2.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/coeff2.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/pvalue2.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/R22.png")
```
...
\
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/Reg_multiple.png")
```
...
```{r, echo=FALSE, out.width = '55%'}
knitr::include_graphics("/home/baptiste.criniere/Documents/Trainings/Linear regression/Course/Image/Ajustement_c.png")
```
